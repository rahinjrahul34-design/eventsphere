  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        title="Yes, relevant"
        className="grid size-6 place-items-center rounded-md hover:bg-muted text-muted-foreground hover:text-emerald-600 transition"
      >
      ...
      <button
        ...
        title="Not for me"
        className="grid size-6 place-items-center rounded-md hover:bg-muted text-muted-foreground hover:text-rose-600 transition"
      >
